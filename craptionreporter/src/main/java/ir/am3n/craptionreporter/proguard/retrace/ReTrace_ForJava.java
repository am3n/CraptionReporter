 ...
 */
public class ReTrace_ForJava {

    private static final String USAGE = "Usage: java proguard.retrace.ReTrace_ForJava [-regex <regex>] [-verbose] <mapping_file> [<stacktrace_file>]";
     ...
     *                          ProGuard.
     */
    public ReTrace_ForJava(String regularExpression, boolean verbose, File mappingFile) {
    ...
    /**
     * The main program for ReTrace_ForJava.
     */
    public static void main(String[] args) {
        ...
        try {
            ...
            InputStreamReader inputStreamReader = new InputStreamReader(stackTraceFile == null ? System.in : fileInputStream, "UTF-8");
            LineNumberReader reader = new LineNumberReader(new BufferedReader(inputStreamReader));
            ...
            try {
                // Execute ReTrace_ForJava with the collected settings.
                new ReTrace_ForJava(regularExpresssion, verbose, mappingFile).retrace(reader, writer);
            } finally {
